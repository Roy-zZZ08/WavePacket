...
// scene parameters
#define SCENE_EXTENT 50.0f					// extent of the entire scene (packets traveling outside are removed)
...
#define PACKET_GPU_BUFFER_SIZE 10000		// maximum number of wave packets to be displayed in one draw call
